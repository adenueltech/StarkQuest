...
const reputationData = {
  ...
  milestones: [
    ...
    { reputation: 4.7, tier: "team", achieved: true, date: "2024-01-20" },
  ...
  recentReviews: [
    {
      ...
      rating: 5.0,
      comment:
        "Exceptional work on the DeFi dashboard. Great communication and delivered ahead of schedule.",
    ...
    },
    {
      ...
      rating: 4.5,
      comment:
        "Solid smart contract work. Could improve on documentation but overall great results.",
...
const reputationTiers = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Early access to premium bounties",
      "Verified badge",
    ],
  },
  {
    ...
    benefits: [
      ...
      "Bounty consultation opportunities",
    ],
  },
  {
    tier: "Legendary",
...
export default function ReputationPage() {
  const currentTier = reputationTiers.find(
    (tier) =>
      reputationData.currentRep >= tier.min &&
      reputationData.currentRep <= tier.max
  );
  const nextTier = reputationTiers.find(
    (tier) => tier.min > reputationData.currentRep
  );
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Build trust and unlock exclusive benefits by maintaining
            high-quality work and excellent client relationships.
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <ReputationBadge
                reputation={reputationData.currentRep}
                size="lg"
              />
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-4xl font-bold text-starknet-blue mb-2">
                  {reputationData.currentRep}
                </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-starknet-orange mb-2">
                  {reputationData.totalReviews}
                </div>
                <div className="text-sm text-muted-foreground">
                  Total Reviews
                </div>
                <div className="text-xs text-muted-foreground mt-2">
                  From {reputationData.totalReviews} clients
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-starknet-pink mb-2">
                  {nextTier
                    ? `${(
                        ((reputationData.currentRep - currentTier!.min) /
                ...
                <div className="text-sm text-muted-foreground">
                  Progress to {nextTier?.tier || "Max Level"}
                </div>
                {nextTier && (
                  <Progress
                    value={
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  {Object.entries(reputationData.breakdown).map(
                    ([category, rating]) => (
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Your lowest score is in timeliness. Try to deliver work
                        ahead of deadlines to boost this score.
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Keep clients updated on progress and respond promptly to
                        messages.
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Maintain high-quality deliverables across all projects
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        {currentTier?.tier === tier.tier && (
                          <Badge
                            variant="outline"
                            className="text-starknet-blue border-starknet-blue"
                          >
                            Current
                          </Badge>
                        )}
