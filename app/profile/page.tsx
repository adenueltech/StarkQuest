      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-6">
            <Link
              href="/dashboard"
              className="flex items-center gap-2 text-starknet-orange hover:text-starknet-pink transition-colors"
            >
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Full-Stack Developer & StarkNet Specialist
                        </p>
                      </div>
                      <Button
                      ...
                      {user?.twitter && (
                        ...
                        >
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-starknet-pink text-starknet-pink hover:bg-starknet-pink hover:text-white transition-all duration-300 bg-transparent"
                          >
                      ...
                      {user?.instagram && (
                        ...
                        >
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-starknet-orange text-starknet-orange hover:bg-starknet-orange hover:text-white transition-all duration-300 bg-transparent"
                          >
                      ...
                      {user?.linkedin && (
                        ...
                        >
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-starknet-blue text-starknet-blue hover:bg-starknet-blue hover:text-white transition-all duration-300 bg-transparent"
                          >
                ...
                <CardContent>
                  {isEditing ? (
                    ...
                    <p className="text-muted-foreground">
                      ...
                      Specialized in StarkNet ecosystem development and have
                      contributed to multiple DeFi protocols. Love solving
                      complex problems and building user-friendly interfaces.
                    </p>
                  )}
                </CardContent>
              </Card>
            ...
            <TabsContent value="skills" className="space-y-6">
              <Card className="border-2 border-starknet-pink/20">
                <CardHeader>
                  ...
                  <CardDescription>
                    Your teamise levels in different technologies
                  </CardDescription>
                </CardHeader>
