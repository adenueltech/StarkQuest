    ...
    <div className="min-h-screen bg-gradient-to-br from-starknet-blue to-starknet-orange flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-starknet-orange mb-2">Welcome Back</h1>
          <p className="text-starknet-orange/80">Sign in to access your profile. You can connect your wallet later.</p>
        </div>
        <AuthForm mode="login" />
      </div>
    </div>
