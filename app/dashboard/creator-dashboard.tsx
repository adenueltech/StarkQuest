...
import { Star, TrendingUp, Clock, DollarSign, Target, Edit, Eye, MessageSquare, Plus, Settings, Search, Filter, Trophy, Users, Calendar, FileText } from "lucide-react"
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <Avatar className="h-16 w-16">
              <AvatarImage src={creatorDashboardData.user.avatar || "/placeholder.svg"} alt={creatorDashboardData.user.name} />
              <AvatarFallback className="text-lg">{creatorDashboardData.user.name.charAt(0)}</AvatarFallback>
            </Avatar>
            <div>
              <h1 className="text-2xl font-bold">Welcome back, {creatorDashboardData.user.name}!</h1>
              <p className="text-muted-foreground">@{creatorDashboardData.user.username}</p>
            </div>
          </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-2xl font-bold">{creatorDashboardData.stats.activeBounties}</div>
              </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-2xl font-bold">{creatorDashboardData.stats.pendingApplications}</div>
              </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-2xl font-bold">{creatorDashboardData.stats.totalRewardsGiven.toLocaleString()}</div>
              </div>
              <p className="text-xs text-muted-foreground">Total Rewards Given (STRK)</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-2xl font-bold">{creatorDashboardData.stats.avgRating}</div>
              </div>
                ...
                <Card key={bounty.id}>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-lg font-semibold">{bounty.applications} applications</div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <h3 className="font-semibold mb-1">{application.bounty}</h3>
                        <p className="text-sm text-muted-foreground">Applicant: {application.applicant}</p>
                      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-2xl font-bold text-starknet-orange">
                      {creatorDashboardData.stats.totalRewardsGiven.toLocaleString()} STRK
                    </div>
                    <div className="text-sm text-muted-foreground">Total Rewards Given</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-starknet-orange">
                      {Math.round(
                        creatorDashboardData.stats.totalRewardsGiven / creatorDashboardData.user.completedBounties,
                      ).toLocaleString()}{" "}
                      STRK
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-lg font-semibold">{creatorDashboardData.user.reputation}</span>
                      </div>
                    </div>

                    <div>
                      <div className="text-sm font-medium text-muted-foreground">Bounties Posted</div>
                      <div className="text-lg font-semibold">{creatorDashboardData.user.completedBounties}</div>
                    </div>

                    <div>
                      <div className="text-sm font-medium text-muted-foreground">Success Rate</div>
                      <div className="text-lg font-semibold">{creatorDashboardData.stats.completionRate}%</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-lg font-semibold">{creatorDashboardData.stats.responseTime} hours</div>
                    </div>

                    <div>
                      <div className="text-sm font-medium text-muted-foreground">Total Rewards Given</div>
                      <div className="text-lg font-semibold">{creatorDashboardData.user.totalRewardsGiven.toLocaleString()} STRK</div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="border-2 border-starknet-blue/20 hover:border-starknet-blue/40 transition-all duration-300">
                    <CardContent className="p-6">
                      <div className="aspect-video bg-gradient-to-br from-starknet-orange/20 to-starknet-pink/20 rounded-lg mb-4 flex items-center justify-center">
                        <span className="text-muted-foreground">DeFi Dashboard Project</span>
                      </div>
                      <h3 className="font-semibold mb-2">DeFi Analytics Dashboard</h3>
                      <p className="text-sm text-muted-foreground mb-4">
                        Built a comprehensive DeFi dashboard for StarkNet with real-time analytics and portfolio tracking.
                      </p>
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Completed: Jan 2024</span>
                  ...
                  <Card className="border-2 border-starknet-orange/20 hover:border-starknet-orange/40 transition-all duration-300">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold mb-2">NFT Marketplace Contract</h3>
                      <p className="text-sm text-muted-foreground mb-4">
                        Developed smart contracts and frontend for a decentralized NFT marketplace on StarkNet.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <Badge variant="outline" className="text-xs">Cairo</Badge>
                        <Badge variant="outline" className="text-xs">Solidity</Badge>
                        <Badge variant="outline" className="text-xs">Web3</Badge>
                      </div>
                      <div className="mt-4 flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Completed: Dec 2023</span>
                        <Button variant="outline" size="sm">View Details</Button>
                      </div>
                    </CardContent>
                  </Card>
